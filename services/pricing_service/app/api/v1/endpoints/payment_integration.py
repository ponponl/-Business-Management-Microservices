...
@router.post("/resolve-for-payment")
def resolve_prices_for_payment(
    payload: PaymentPriceResolveRequest,
    db: Session = Depends(get_db),
):
    return PaymentIntegrationService.resolve_prices_for_payment(db, payload)