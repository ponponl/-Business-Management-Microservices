...
import { CalendarDays, CheckCircle2, Clock3, FileCheck2, Pencil, Search, SlidersHorizontal, Users, XCircle } from 'lucide-react';
    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                setSummary(contractResponse.summary || {});
                setTotalContracts(contractResponse.total || 0);
                setCustomers(customerResponse || []);
            } catch (loadError) {
                setError(loadError.message || 'Không thể tải dữ liệu hợp đồng.');
            } finally {
                setIsLoading(false);
            }
        };
        loadData();
    }, [page, statusFilter, searchQuery, dateQuery]);
